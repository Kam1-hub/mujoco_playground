...
# ==============================================================================
"""RL config for G1 Locomotion envs."""
...
def brax_ppo_config(
  ...
  """Returns tuned Brax PPO config for the given G1 environment."""
  ...
  if env_name in ("G1JoystickFlatTerrain", "G1JoystickRoughTerrain"):
...
def rsl_rl_config(
  ...
  """Returns tuned RSL-RL PPO config for the given G1 environment."""
