...
| Actor mean drift amplifies by fresh 250k | policy diagnostics | OPEN | Fresh 250k diagnostic showed actor mean abs increasing from fresh 100k `0.238568 -> 0.299021`, deterministic action abs `0.218864 -> 0.270944`, final log_std `-0.157116 -> -0.205270`, and alpha `0.032585 -> 0.018768`. | Do not run 750k/1M automatically. Use A4 500k evidence in a decision review before any longer run. |
| A4 alpha/entropy ablation mitigates but does not eliminate drift | policy diagnostics | OPEN | Fresh 100k A1/A3/A4 ablations all passed runtime, checkpoint readiness, and eval gates. Bounded fresh 250k and 500k A4 extensions also passed. At 500k, A4 had alpha `0.02435`, actor mean abs `0.29323`, deterministic action abs `0.26540`, log_std `-0.22279`, and std `0.80245`; this mitigates the old fresh 500k alpha collapse and deterministic drift pattern, but still drifts relative to A4 250k. | Do not jump to 750k/1M. Run a decision review before any longer A4 extension or further diagnostic. |
